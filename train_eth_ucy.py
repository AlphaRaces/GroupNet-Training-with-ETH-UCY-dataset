...
from data.dataloader_ethucy import ETHUCYDataset, seq_collate
...
parser.add_argument('--past_length', type=int, default=2)
parser.add_argument('--future_length', type=int, default=3)
...
parser.add_argument('--hyper_scales', nargs='+', type=int, default=[4,8])
parser.add_argument('--num_decompose', type=int, default=2)
parser.add_argument('--min_clip', type=float, default=2.0)

parser.add_argument('--model_save_dir', default='saved_models/eth_ucy')
